...
Always start by reading the overview to understand the full system map:

```
Read ~/.claude/repo_notes/<repo_id>/notes/00-overview.md
```

This gives you the Knowledge Map — use it to identify which topic notes are relevant to the question.
...
```
Read ~/.claude/repo_notes/<repo_id>/notes/<relevant-topic>/index.md
Read ~/.claude/repo_notes/<repo_id>/notes/<relevant-topic>/<specific-note>.md
```
...
Answer from notes first. Cite the specific notes you're drawing from.
